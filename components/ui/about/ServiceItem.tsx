  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-xl font-medium text-black dark:text-white group-hover:text-[#88734C] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
        className="text-sm text-black/80 dark:text-white/80 leading-relaxed pl-12"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
