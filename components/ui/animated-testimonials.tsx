...
export const AnimatedTestimonials = ({
  ...
  // Pre-compute stable random rotations instead of calling Math.random() during render
  ...
  return (
    <div
      className={cn(
        "max-w-sm md:max-w-4xl mx-auto px-4 md:px-8 lg:px-12 py-16",
        className
      )}
    >
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.div className="text-lg text-muted-foreground mt-8 space-y-2">
