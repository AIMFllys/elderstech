...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
  ...
  return (
    <section
      className={`relative overflow-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen flex flex-col ${className}`}
    >
      <div
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-40 md:-mt-52 lg:-mt-64">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
            记录我们走访养老机构、医院老年科室与社区的瞬间，用影像连接需求与改变。
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-6 py-3 rounded-full bg-hust dark:bg-hust-light text-white hover:bg-hust-dark dark:hover:bg-hust transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              浏览剪影
            </button>
