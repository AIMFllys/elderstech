...
export function FocusRail({
    ...
    return (
        <div
            className={cn(
                "group relative flex h-[600px] w-full flex-col overflow-hidden bg-transparent text-foreground outline-none select-none overflow-x-hidden",
                className
            )}
            ...
            <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
                ...
                <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-1 rounded-full bg-secondary/50 p-1 ring-1 ring-border backdrop-blur-md">
                            <button
                                onClick={handlePrev}
                                className="rounded-full p-3 text-muted-foreground transition hover:bg-secondary hover:text-foreground active:scale-95"
                                aria-label="Previous"
                            >
                        ...
                        {activeItem.href && (
                            <Link
                                ...
                                className="group flex items-center gap-2 rounded-full px-5 py-3 text-sm font-semibold transition-all hover:scale-105 active:scale-95 bg-white/90 dark:bg-white/10 hover:bg-white dark:hover:bg-white/15 text-black dark:text-white border border-black/5 dark:border-white/10 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_15px_45px_rgb(0,0,0,0.1)]"
                            >
                                Explore
