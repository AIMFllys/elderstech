...
const MilestoneMarker = ({ milestone }: { milestone: Milestone }) => {
  const statusClasses = {
    complete: "bg-emerald-500 border-emerald-700",
    "in-progress": "bg-amber-400 border-amber-700 animate-pulse",
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.5, delay: milestone.id * 0.25, ease: "easeOut" }}
