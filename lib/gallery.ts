...
export const galleryArcImages = [
  ...
  "https://images.unsplash.com/photo-1502303756762-ae2bc5d2c2a1?auto=format&fit=crop&w=400&q=80",
];
...
export const galleryMediaItems: MediaItemType[] = [
  ...
  },
  {
    ...
    title: "医疗场景观察",
    desc: "慢病管理与随访的实际流程",
    url: "https://images.unsplash.com/photo-1580281657527-47f249e8f0a7?auto=format&fit=crop&w=800&q=80",
